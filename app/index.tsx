...
import { dumpCart, setCompCode, setLocation, setLogin, setUser } from '@/src/store/slices/slices';
...
export default function App() {
  ...
  console.log(new Date("2018-02-15T00:00:00").toLocaleDateString('en-TT'));
  ...
  const handleSelect = (comanyCode: string) => {
    ...
    dispatch(setLogin(false));   // logout.
    dispatch(setUser({}))
    dispatch(dumpCart())
