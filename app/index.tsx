...
import { compId } from '@/src/constants';
...
export default function App() {
  ...
  const { info, vType, status } = useSelector((i: RootState) => i.company)
        ...
        <SafeAreaProvider>
          <SafeAreaView className="flex-1">
            ...
            <View className="relative gap-4 items-center justify-center py-[2rem] bg-white">
              <Image className='' source={{ uri: `https://erp.gsterpsoft.com/Content/CompanyLogo/${info.LogoUrl}` }} style={{ width: 200, height: 190 }} />    
