...
const AppnList = ({ memberId }: any) => {
    ...
    // const { list: companyList, selected: selected } = useSelector((state: RootState) => state.companies);
    ...
    //     if (user.UserId > 1) {
    //     const res = await getFrom(`${baseUrl}/api/DashBoard/Get?UserId=${user.UserId}&CID=${company.CompanyId}&Location=${company.LocationId}&RoleId=${user.UserRoleLevelCode}&dtfrStr=01/03/2026&dttoStr=05/03/2026`, {}, setDepartment, signal);
    //     if (res) {
