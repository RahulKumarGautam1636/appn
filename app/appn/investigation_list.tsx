...
//             if (res) {
//                 let onlyInv = res.data.PatientRegList.find((i: any) => i.DeptCategory === 'INVESTIGATION');
//                 if (!onlyInv) {
//                     alert('Something went wrong.')
//                     return;
//                 }
//                 setStages(onlyInv.LinkStageList)
//                 setSelectedStage(onlyInv.LinkStageList[0])
//                 setSelectedDepartment(onlyInv)
//             }
//         }
//     };
