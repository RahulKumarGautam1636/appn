import { Card_2, MyModal } from "@/src/components";
        ...
        <SafeAreaView className="flex-1 bg-gray-100">
          ...
          <View className="pb-2 bg-white">
              ...
              <Pressable onPress={() => router.back()} className="flex-row items-center gap-3">
                  ...
                  <Text className="font-PoppinsSemibold text-gray-700 text-[15px] items-center leading-5">Personal Details</Text>
              </Pressable>
              <Pressable onPress={() => setPersonalInfoActive(true)} className="gap-3 flex-row items-center ml-auto">
