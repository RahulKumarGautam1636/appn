...
export default function InvoicePreview() {
  ...
  <body>
    <div
      class="print-page prescription invoice-print"
      id="printContent"
      style="width: 100%"
    >
                          ...
                          <tbody>
                            <tr>
                              <td style="width: 15%; padding: 5px">
                                <img
                                  src="https://erp.gsterpsoft.com/Content/CompanyLogo/612.png"
                              ...
                              <td style="width: 15%">
                                <img
                                  src="https://erp.gsterpsoft.com/Content/CompanyLogo/R_LOGO612.png"
                                  style="
                                    height: auto;
                                    max-width: 100%;
                                    max-height: 100%;
                            ...
                            <tr>
                              <td
                                colspan="3"
                                style="height: 2px; border-bottom: 2px solid"
                              ></td>
                            </tr>
                            <tr>
                            ...
                            >
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="2">
                                    <span>
                                      Receive with thanks from Dr k Gautam an
                                      amount of
                                      <b> Rupees One Thousand Only</b> by
                                      Hospital demo
                                    </span>
                                  </td>
                                  <td
  ...
  const generatePDF = async () => {
    ...
    setPdfUri(uri); // Save for preview
  };
      ...
      {pdfUri && (
        <>
          <WebView
            ...
            source={{ html: html }}
            style={{ flex: 1 }}
            allowFileAccess={true}          // 👈 important for Android
            allowUniversalAccessFromFileURLs={true}
          />
          <ButtonPrimary title='SHARE' active={true} onPress={sharePDF} classes='my-4 !bg-slate-700 !h-[45px]' />
        </>
      )}
    </View>
  );
