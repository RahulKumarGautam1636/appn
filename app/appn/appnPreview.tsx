  ...
  return (
    ...
    >
      <View className='flex-1'>
        ...
        <ButtonPrimary title='Confirm Booking' active={true} onPress={() => alert('Button Pressed')} classes='mx-4 mb-4' />
        <View className='bg-white m-4 rounded-3xl shadow-md shadow-gray-400'>
            ...
            <View className='flex-row gap-3 p-4'>
              <FontAwesome5 name="clock" size={17} color="#000" />
              <Text className="font-PoppinsSemibold text-slate-500 text-[14px] mr-8">{bookingData.AppTime}</Text>
              <FontAwesome5 name="calendar-alt" size={17} color="#000" />
