...
import { getFrom, GridLoader, NoContent } from "@/app/components/utils";
import { BASE_URL } from "@/constants";
import { Card_1, DayBtn, getDatesArray } from "@/app/components";
...
const Clinic = () => {
    ...
    const companyId = companiesList.find((i: any) => String(i.CompanyId) === String(compId))?.EncCompanyId;
