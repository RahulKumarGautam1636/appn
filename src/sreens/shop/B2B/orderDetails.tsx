...
import ButtonPrimary, { B2BCOrderCard, MyModal } from '@/src/components';
    ...
    <>
      <ScrollView contentContainerClassName="bg-purple-50 min-h-full p-4">
        ...
        {orders.loading ? <GridLoader /> : <>
          ...
          <Text className='text-[1.05rem] mt-4 mb-3 font-PoppinsSemibold'>Other Details</Text>
          <View className='bg-white rounded-3xl px-4 py-2 shadow-sm border-b border-gray-200'>
              ...
              <View className='flex-row gap-3 px-1 py-[0.9rem] border-b border-gray-100'>
                  <Text className="text-slate-600 font-bold text-[13px] mr-auto">Distributer Name :</Text>
          ...
          <View className='gap-3'>
            {order?.SalesDetailsList?.map((item, index) => <B2BCOrderCard data={item} key={index} />)}
          </View>
          <View className='mt-4 mb-3 border-b border-gray-300 pb-2'>
              <View className='justify-between flex-row px-1 py-2 items-center'>
                  <View className='flex-row items-center gap-3'>
                      <Text className="font-PoppinsSemibold text-gray-500 text-[13px] items-center leading-5">Total MRP</Text>
                  </View>
                  <Text className="font-PoppinsMedium text-slate-700 text-[13px] ml-auto leading-5">{maxPrice}</Text>
              </View>
              <View className='flex-row gap-3 px-1 py-2'>
                  <Text className="font-PoppinsSemibold text-slate-500 text-[13px] mr-auto">Total PTR</Text>
                  <Text className="font-PoppinsMedium text-[13px] text-slate-700">{totalPTR}</Text>
              </View>
              <View className='flex-row gap-3 px-1 py-2'>
                  <Text className="font-PoppinsSemibold text-slate-500 text-[13px] mr-auto">Total Discount</Text>
                  <Text className="font-PoppinsMedium text-[13px] text-slate-700">- {totalDiscount}</Text>
              </View>
              <View className='flex-row gap-3 px-1 py-2'>
                  <Text className="font-PoppinsSemibold text-slate-500 text-[13px] mr-auto">Total GST</Text>
                  <Text className="font-PoppinsMedium text-[13px] text-slate-700">+ {totalGST}</Text>
              </View>
              <View className='flex-row gap-3 px-1 py-2'>
                  <Text className="font-PoppinsSemibold text-slate-500 text-[13px] mr-auto">Total Payable</Text>
                  <Text className="font-PoppinsMedium text-[13px] text-slate-700">₹ {num(order.Amount)}</Text>
              </View>
          </View>
