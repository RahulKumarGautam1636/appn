...
// ScrollView replaced with FlatList only Home component.
...
//           </View>
//           {/* <ProductSection mainCategories={categoriesData.LinkCategoryList} productsData={productsData} /> */}
//           {productsData.loading ? <GridLoader classes="h-[45px] w-[100px] rounded-xl" containerClass="flex-row gap-3 m-4" /> : <Text className="px-4 text-[16px] font-bold text-gray-800 mb-2">Products</Text>}
//         </View>
//       }
//       // ListFooterComponent={}
//     />
